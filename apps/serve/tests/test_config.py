...
from mira_serve import config
from mira_serve.config import load_settings
...
def test_config_default_values() -> None:
    ...
    with (
        ...
        assert settings.enrollment_sync_enabled is False
...
def test_config_env_overrides() -> None:
    ...
    with (
        ...
        assert settings.enrollment_sync_enabled is True
